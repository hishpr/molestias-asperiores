...
[![NPM Version](https://img.shields.io/npm/v/@hishpr/molestias-asperiores.svg?style=flat-square)](https://www.npmjs.com/package/@hishpr/molestias-asperiores)
[![Downloads](http://img.shields.io/npm/dm/@hishpr/molestias-asperiores.svg?style=flat-square)](https://www.npmjs.org/package/@hishpr/molestias-asperiores)
[![Build Status](https://img.shields.io/travis/hishpr/molestias-asperiores/master.svg?style=flat-square)](https://travis-ci.org/hishpr/molestias-asperiores)
[![Coverage Status](https://img.shields.io/coveralls/hishpr/molestias-asperiores/master.svg?style=flat-square)](https://coveralls.io/github/hishpr/molestias-asperiores?branch=master)
...
```sh
npm install --save-dev @hishpr/molestias-asperiores
```
